...
import {uploadMovie, uploadTrailer} from "../../api/MovieApi";
    ...
    return (
        <ModalContainer visible={visible}>
            ...
            {!videoSelected ? (
                ...
                <MovieForm busy={busy} onSubmit={!busy ? handleSubmit : null} btnTitle="Create" onClose={onClose}/>
            )}
        </ModalContainer>
    );
}
...
const TrailerSelector = ({visible, handleChange, onTypeError}) => {
    ...
    return (
        <div className="h-full flex items-center justify-center pb-20">
            ...
            >
                <label
                    className="w-48 h-48 border bg-amber-100 border-dashed dark:border-dark-subtle border-light-subtle rounded-full flex flex-col items-center justify-center dark:text-dark-subtle text-secondary cursor-pointer">
