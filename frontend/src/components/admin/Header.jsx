...
export default function Header({ onAddActorClick, onAddMovieClick, onAddDirectorClick, onAddWriterClick }) {
    ...
    const options = [
        ...
        { title: "Add Director", onClick: onAddDirectorClick },
        { title: "Add Writer", onClick: onAddWriterClick},
    ];
