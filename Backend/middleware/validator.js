...
exports.userValidator = [check("name").trim().not().isEmpty().withMessage("Name is empty"),
...
exports.actorInfoValidator = [
    ...
    check("about").trim().not().isEmpty().withMessage("About is empty"),
    check("gender").trim().not().isEmpty().withMessage("Gender is empty"),

]

exports.validatePassword = [check('newPassword').trim().not().isEmpty().withMessage("Password is empty").isLength({
    min: 8,
    max: 20
}).withMessage('Password must be 8 to 20 characters'),
];
